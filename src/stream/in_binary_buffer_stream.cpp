#include <azgra/stream/in_binary_buffer_stream.h>
namespace azgra
{
...
azgra::i64 InBinaryBufferStream::get_position()
{
    ...
    case BufferSourceType_Stream:
    {
        ...
        azgra::i64 pos = (this->readedFromSource > 0) ? this->readedFromSource - (this->streamBufferSize - this->currentBufferPosition) : 0;
        return pos;
    }
    break;
    default:
